...
public class ElitisticListPopulation_ESTest extends ElitisticListPopulation_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(4651, 0.0);
  ...
  public void test01()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(1444, 0.0);
      Population population0 = elitisticListPopulation0.nextGeneration();
  ...
  public void test04()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(282, 0.0);
      List<Chromosome> list0 = elitisticListPopulation0.getChromosomes();
      ElitisticListPopulation elitisticListPopulation1 = null;
      try {
        elitisticListPopulation1 = new ElitisticListPopulation(list0, 1590, (-667.7693518040637));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-667.769)
         //
  ...
  public void test06()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((-3389), 0.0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(204, (-1982.7056860462585));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-1,982.706)
         //
         verifyException("math.genetics.ElitisticListPopulation", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        elitisticListPopulation0.setElitismRate(1804.5878617240808);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (1,804.588)
         //
         verifyException("math.genetics.ElitisticListPopulation", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(1444, 0.0);
      try { 
        elitisticListPopulation0.setElitismRate((-2819.169341812));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-2,819.169)
         //
         verifyException("math.genetics.ElitisticListPopulation", e);
      }
  }
