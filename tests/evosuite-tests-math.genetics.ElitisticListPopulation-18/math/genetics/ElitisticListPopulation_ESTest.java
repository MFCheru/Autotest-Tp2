...
public class ElitisticListPopulation_ESTest extends ElitisticListPopulation_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(3257, 0.0);
  ...
  public void test02()  throws Throwable  {
      ...
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 0, (-114.48197107));
  ...
  public void test03()  throws Throwable  {
      ...
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 1, 1958.7328037);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (1,958.733)
         //
  ...
  public void test06()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(306, 306);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(2039, 1.0);
      try { 
        elitisticListPopulation0.setElitismRate(2039);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      ...
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 1, 1);
      try { 
        elitisticListPopulation0.setElitismRate((-2193.1319));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-2,193.132)
         //
         verifyException("math.genetics.ElitisticListPopulation", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      elitisticListPopulation0.setPopulationLimit(368);
      elitisticListPopulation0.addChromosome((Chromosome) null);
