...
public class FixedOrderComparator_ESTest extends FixedOrderComparator_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator();
      fixedOrderComparator0.add("kV");
      fixedOrderComparator0.compare("kV", "kV");
  ...
  public void test08()  throws Throwable  {
      ...
      int int0 = fixedOrderComparator0.compare("}U*.O]Ig;O |[", "kV");
  ...
  public void test09()  throws Throwable  {
      ...
      fixedOrderComparator0.add("kV");
      fixedOrderComparator0.setUnknownObjectBehavior(1);
      int int0 = fixedOrderComparator0.compare("kV", fixedOrderComparator0);
      assertTrue(fixedOrderComparator0.isLocked());
      assertEquals((-1), int0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator(objectArray0);
      fixedOrderComparator0.setUnknownObjectBehavior(0);
      int int0 = fixedOrderComparator0.compare(fixedOrderComparator0.UNKNOWN_BEFORE, objectArray0[2]);
      assertTrue(fixedOrderComparator0.isLocked());
      assertEquals((-1), int0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.compare("kV", fixedOrderComparator0);
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.compare("}U*.O]Ig;O |[", "kV");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Attempting to compare unknown object }U*.O]Ig;O |[
         //
         verifyException("collections.comparators.FixedOrderComparator", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.addAsEqual("_yE=", fixedOrderComparator0.UNKNOWN_THROW_EXCEPTION);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // _yE= not known to collections.comparators.FixedOrderComparator@1
         //
         verifyException("collections.comparators.FixedOrderComparator", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      objectArray0[0] = object0;
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator(objectArray0);
      boolean boolean0 = fixedOrderComparator0.addAsEqual(object0, "Gv");
      assertEquals(2, fixedOrderComparator0.getUnknownObjectBehavior());
      assertTrue(boolean0);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.setUnknownObjectBehavior(1764);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.setUnknownObjectBehavior((-2022));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.addAsEqual("kV", fixedOrderComparator0);
        fail("Expecting exception: UnsupportedOperationException");
